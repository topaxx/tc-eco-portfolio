    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <div className="bg-gray-800 border-b border-gray-700">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div>
            <h1 className="text-3xl font-bold text-white">Thorchain Ecosystem Portfolio Tracker</h1>
            <p className="text-gray-400 mt-1">Track your multi-wallet crypto positions</p>
          </div>
        </div>
      </div>
